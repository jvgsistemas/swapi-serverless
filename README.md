...
```
curl --request POST 'https://xxxxxx.execute-api.us-east-1.amazonaws.com/users' --header 'Content-Type: application/json' --data-raw '{"name": "John", "userId": "someUserId", "filmId":"swapiFilmId", "filmTitle":"swapiFilmTitle"}'
```

Which should result in the following response:

```json
{ "userId": "someUserId", "name": "John", "filmId": "1", "filmTitle": "A New Hope" }
```
...
Open swagger-swapi-serverless file

### TEST

File .env only used by test.
